...
stage_link() {
  ...
  emcc -O2 -s DISABLE_EXCEPTION_CATCHING=0 "$OBJ"/*.o \
    ...
    -s EXPORTED_FUNCTIONS='["_PyInit__C","_wasthon_init","_wasthon_module_create","_wasthon_torch_property_addr","_wasthon_torch_staticmethod_addr","_wasthon_census_kind","_wasthon_census_tensor","_wasthon_census_mallinfo","_wasthon_census_edge","_malloc","_free"]' \
